        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white p-5">
          ...
          @csrf
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                {{-- -phone --}}
                <div>
                    <label for="phone" name="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone number</label>
                ...
                <div>
                    ...
                    <input type="text" id="visitors" name="teacherId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" >
                    @error('teacherId')
                  <span class="text-red-500">{{$message}}</span>
                @enderror
                </div>
